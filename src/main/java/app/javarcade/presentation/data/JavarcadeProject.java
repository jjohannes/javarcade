...
public interface JavarcadeProject {
    ...
    static Set<Module> modules() {
        return Set.of(
                ...
                new Module("classic-assets.jar", 0, 1, Set.of("base-model.jar", "commons-io-2.18.0.jar")),
                ...
                new Module("slf4j-api-2.0.17.jar", 0, 2),
                new Module("slf4j-simple-2.0.17.jar", 1, 2, Set.of("slf4j-api-2.0.17")),
                new Module("slf4j-jdk14-2.0.17.jar", 2, 2, Set.of("slf4j-api-2.0.17")),
                new Module("commons-io-2.18.0.jar", 0, 3),
                new Module("commons-csv-1.14.0.jar", 1, 3, Set.of("commons-io-2.18.0.jar", "commons-codec-1.18.0.jar")),
                new Module("commons-codec-1.18.0.jar", 2, 3),
                new Module("commons-io-2.16.1.jar", 3, 3),
