package app.javarcade.renderer.lwjgl.textures;
...
public class TextureManagement {
    public static int loadTexture(byte[] imageData) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            textureId = loadTextureFromBuffer(decodedImage, width, height);
        }
    ...
    public static int renderCharacter(char character) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            return loadTextureFromBuffer(rgbaBuffer, widthBuffer, heightBuffer);
        }
    }

    private static int loadTextureFromBuffer(ByteBuffer imageBuffer, IntBuffer width, IntBuffer height) {
